...
p1 = os.path.join('../../','work','CookIRCamET','Images','CookHY2023','V2','TifPng','RGB')
p2 = os.path.join('../../','work','CookIRCamET','Images','CookHY2023','V2','TifPng')
p00 = os.path.join('../../','raw','CookIRCamET','Images','CprlHY2023')
p11 = os.path.join('../../','work','CookIRCamET','Images','CprlHY2023','V2','TifPng','RGB')
p22 = os.path.join('../../','work','CookIRCamET','Images','CprlHY2023','V2','TifPng')
...
M_mlp3_df.to_csv(os.path.join(p3,'M3_mlp_v2.csv'))
